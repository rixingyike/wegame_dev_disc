// JS：disc\第3章\3.4\3.4.5_2\index.js
// 获取画布及2D渲染上下文对象
...
//     musicBtnOnImg.src = "./sound_on.png"
//     context.fillStyle = context.createPattern(musicBtnOnImg, "no-repeat")
//   } else {
//     const musicBtnOffImg = new Image()
//     musicBtnOffImg.src = "./sound_off.png"
//     context.fillStyle = context.createPattern(musicBtnOffImg, "no-repeat")
//   }
...
function drawBgMusicButton() {
  ...
  if (bgMusicIsPlaying) {
    const musicBtnOnImg = new Image()
    musicBtnOnImg.src = "./sound_on.png"
    btnContext.fillStyle = context.createPattern(musicBtnOnImg, "no-repeat")
  } else {
    const musicBtnOffImg = new Image()
    musicBtnOffImg.src = "./sound_off.png"
    btnContext.fillStyle = context.createPattern(musicBtnOffImg, "no-repeat")
  }
  btnContext.fillRect(0, 0, 28, 28)
  context.drawImage(btnCanvas, 0, 0, 28, 28, 5, 5, 15, 15)
}
