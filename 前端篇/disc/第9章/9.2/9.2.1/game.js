...
// import { testForHBox, testForVBox, testForComplexBox, testForSquare } from "src/views/box_test.js"
...
class Game extends EventDispatcher {
  ...
  #render() {
    ...
    // testForSquare(this.#context)
    // testForHBox(this.#context)
    // testForVBox(this.#context)
    // testForComplexBox(this.#context)
  }
