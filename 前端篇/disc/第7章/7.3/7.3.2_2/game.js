// JS：disc\第7章\7.3\7.3.2_2\game.js
...
// import Panel from "src/views/panel.js" // 引入挡板类
...
//   if (ball.x > (canvas.width - GameGlobal.RADIUS - PANEL_WIDTH)) { // 碰撞右挡板
//     if (ball.y > rightPanelY && ball.y < (rightPanelY + PANEL_HEIGHT)) {
//       ball.switchSpeedX()
...
//       playHitAudio()
//     }
// } else if (ball.x < GameGlobal.RADIUS + PANEL_WIDTH) { // 触达左挡板
//   if (ball.y > leftPanelY && ball.y < (leftPanelY + PANEL_HEIGHT)) {
//     ball.switchSpeedX()
