...
class Background {
  ...
  render(context) {
    ...
    let posY = 0
      ...
      // , OtherDrawLineCommandClass = () => { }
    // OtherDrawLineCommandClass.prototype = drawLineCommandInstance
    for (var i = 0; ; i++) {
      if (i % 2) continue // 取模操作，逢奇数跳过
      posY = i * 10
      let y = posY
      // set.add(new DrawLineCommand(context, startX, y))
      // const c = new OtherDrawLineCommandClass()
      const c = {}
