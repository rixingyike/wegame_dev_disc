// JS：disc\第7章\7.1\minigame\game.js
...
import storageServiceMgr from "src/managers/storage_service_facade.js" // 存储服务外观管理者
...
class Game extends EventDispatcher {
  ...
  async #onError(res) {
    ...
    storageServiceMgr.writeError(res.message)
    console.log("readErrors", (await storageServiceMgr.readErrors()).data)
  }
}
