...
CREATE TABLE `pay_order` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `openid` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `total_fee` int DEFAULT NULL,
  `order_body` varchar(128) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `out_trade_no` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `order_id` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `nonce_str` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `qrcode_url` varchar(2083) COLLATE utf8mb4_general_ci DEFAULT NULL,
